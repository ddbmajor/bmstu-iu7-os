...
START_TEST(test_add_usual_matrix)
{
    int rc;
    matrix_t *m1 = init_matrix();
    m1->data = allocate_matrix(3, 3);
...
Suite* add_suite(void)
{
    ...
    tcase_add_test(tc_neg, test_add_dim_error);
    ...
    tcase_add_test(tc_pos, test_add_usual_matrix);
