...
% \section{Заключение}
% Выполнив данную лабораторную работу, я научилась получать адреса и листинги обработчиков прерываний с помощью утилиты debug и дизассемблера 
% soucer соответственно. Также я изучила алгоритм работы обработчика прерывания INT 8h. Это прерывание отвечает за изменение системного 
